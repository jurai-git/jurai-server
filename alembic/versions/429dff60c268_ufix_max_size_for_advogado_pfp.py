"""ufix max size for advogado pfp

Revision ID: 429dff60c268
Revises: d7ef9dfb1908
Create Date: 2025-06-04 13:54:57.587524
...
revision: str = '429dff60c268'
down_revision: Union[str, None] = 'd7ef9dfb1908'
...
def upgrade() -> None:
    ...
    op.alter_column('advogado_pfp', 'data',
